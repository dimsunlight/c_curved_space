This suite of files is designed to evaluate the accuracy of CGAL's
distance finding algorithms and their execution time. The list of 
...
I will test both the time-to-completion of distance 
