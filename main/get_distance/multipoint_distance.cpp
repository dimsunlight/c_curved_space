//Author: CGAL user manual.
//Description: for now, just example 3.4 ("using multiple source points") from the distance calculation module of the user manual.
#include <cstdlib>
#include <iostream>
#include <fstream>
#include <iterator>
...
int main(int argc, char** argv)
{
  // read input tmesh
  Triangle_mesh tmesh;
  std::ifstream input((argc>1)?argv[1]:"\\wsl.localhost\\Ubuntu\\home\\toler\\projects\\CGAL_curvature\\main\\get_distance\\torus.off");
  input >> tmesh;
  input.close();
